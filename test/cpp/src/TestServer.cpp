...
int main(int argc, char **argv) {
    ...
    // Dispatcher
    boost::shared_ptr<TProtocolFactory> protocolFactory(new TBinaryProtocolFactoryT<TBufferBase>());
    ...
    // Transport
    boost::shared_ptr<TServerChannel> serverTransport(new TServerChannel(input_channel, output_channel));
